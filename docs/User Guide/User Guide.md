# User Guide
Trilium is an open-source solution for note-taking and organizing a personal knowledge base. Use it locally on your degesktop, or sync it with your self-hosted server to keep your notes everywhere you go.

> [!TIP]
> The same documtentation can be accessed locally from within the Trilium Notes application by pressing F1.
