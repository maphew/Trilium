...
| `template:newNoteDefaultParent` | set on a template note, points to the note under which notes created from the template are placed when no other location is picked. See <a class="reference-link" href="../Templates.md">Templates</a>. |
